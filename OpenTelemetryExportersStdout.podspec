Pod::Spec.new do |spec|
  spec.name = "OpenTelemetryExportersStdout"
  spec.version = "1.10.1"
  spec.summary = "Swift OpenTelemetryExportersStdout"
  ...
  spec.source_files = "Sources/Exporters/OpenTelemetryExportersStdout/**/*.swift"
  ...
  # This is necessary because we use the `package` keyword to access some properties in `OpenTelemetryExportersStdout`
  ...
  # `swift build --verbose`
  spec.pod_target_xcconfig = { "OTHER_SWIFT_FLAGS" => "-module-name OpenTelemetryExportersStdout -package-name opentelemetry_swift" }
