Pod::Spec.new do |spec|
  spec.name = "OpenTelemetryResourceExtension"
  spec.version = "1.10.1"
  spec.summary = "Swift OpenTelemetryResourceExtension"
  ...
  # This is necessary because we use the `package` keyword to access some properties in `OpenTelemetryResourceExtension`
  ...
  # `swift build --verbose`
  spec.pod_target_xcconfig = { "OTHER_SWIFT_FLAGS" => "-module-name OpenTelemetryResourceExtension -package-name opentelemetry_swift" }
