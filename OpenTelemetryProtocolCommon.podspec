Pod::Spec.new do |spec|
  spec.name = "OpenTelemetryProtocolCommon"
  spec.version = "1.10.1"
  spec.summary = "Swift OpenTelemetryProtocolCommon"
  ...
  # This is necessary because we use the `package` keyword to access some properties in `OpenTelemetryProtocolCommon`
